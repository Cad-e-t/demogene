        ...
        <div className="min-h-screen bg-white text-gray-900 selection:bg-green-500 selection:text-white font-sans">
            <div className="max-w-4xl mx-auto px-6 py-12 md:py-24">
                ...
                <div className="mt-32 p-10 bg-gray-50 rounded-[40px] text-center border border-gray-100">
                    ...
                    <button onClick={() => onNavigate('/')} className="inline-block px-10 py-4 bg-green-600 text-white font-black rounded-2xl hover:bg-green-700 transition shadow-xl shadow-green-600/20 uppercase tracking-tighter">
                        Get Started
                    </button>
                </div>
                ...
                <footer className="mt-32 pt-12 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex gap-8">
                        ...
                        <button onClick={() => onNavigate('/about')} className="text-xs font-bold text-gray-400 hover:text-gray-900 uppercase tracking-widest transition-colors">About</button>
