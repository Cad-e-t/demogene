    ...
    return (
        <div className="flex-1 h-full overflow-y-auto bg-gray-50 p-6 md:p-12">
            ...
            <div className="md:hidden flex items-center justify-between mb-6 sticky top-0 bg-gray-50 z-20 py-2">
                ...
                <h1 className="text-xl font-black text-gray-900 uppercase tracking-tighter">Dashboard</h1>
                <div className="w-8"></div> {/* Spacer for centering */}
            </div>

            {/* Desktop Header */}
            <h1 className="hidden md:block text-3xl font-black text-gray-900 mb-8 uppercase tracking-tighter">Dashboard</h1>
