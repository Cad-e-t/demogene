...
export const CreatorPricingView = ({ onViewChange }: any) => {
    ...
    return (
        <div className="flex-1 h-full overflow-y-auto bg-black p-6 md:p-12 flex flex-col items-center">
            <div className="w-full max-w-6xl">
                <button 
                    onClick={() => onViewChange('billing')}
                    className="inline-flex items-center gap-2 text-xs font-bold text-zinc-500 hover:text-white mb-8 uppercase tracking-widest transition-colors"
                >
                ...
                <h1 className="text-4xl font-black text-white mb-12 text-center uppercase tracking-tighter">Get Credits</h1>
