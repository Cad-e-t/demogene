            ...
            <div className="flex-1 h-full relative flex flex-col">
                ...
                <div className="md:hidden absolute top-4 left-4 z-20 flex items-center gap-3">
                    <button 
                        ...
                        className="p-2 -ml-2 bg-black/80 backdrop-blur rounded-lg text-white shadow-sm border border-white/10"
                    >
                ...
                <div className={`absolute top-4 right-4 z-30 ${isConfigOpen && 'md:hidden'}`}>
                    <button 
                        ...
                        className="p-3 text-black bg-yellow-400 hover:bg-yellow-300 rounded-full transition-all shadow-lg hover:shadow-xl transform hover:scale-105 group"
                ...
                <div className={`
                    ...
                    w-80 bg-black border-l border-white/10 p-6 
                ...
                `}>
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="font-black text-xl uppercase tracking-tight text-white">Configuration</h3>
                        <button onClick={() => setIsConfigOpen(false)} className="p-1 text-zinc-500 hover:text-white hover:bg-white/10 rounded-full transition-colors">
                    ...
                    {configView === 'main' && (
                        <>
                            <div className="space-y-6">
                                ...
                                <div>
                                    <h4 className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-3 border-b border-white/10 pb-2">Visual Config</h4>
                                    
                                    <div className="space-y-3">
                                        <button 
                                            onClick={() => setConfigView('style')}
                                            className="w-full flex items-center justify-between p-2 pl-3 rounded-xl bg-zinc-900 border border-white/10 text-sm font-bold hover:border-yellow-400 hover:bg-yellow-400/10 transition-all group text-left"
                                        >
                                            <div className="flex items-center gap-3">
                                                <div className="w-8 h-8 rounded-lg overflow-hidden bg-zinc-800 shrink-0 shadow-sm border border-white/10">
                                            ...
                                            <svg className="w-4 h-4 text-zinc-600 group-hover:text-yellow-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                                        </button>

                                        <button 
                                            onClick={() => setConfigView('aspect')}
                                            className="w-full flex items-center justify-between p-3 rounded-xl bg-zinc-900 border border-white/10 text-sm font-bold hover:border-yellow-400 hover:bg-yellow-400/10 transition-all group text-left"
                                        >
                                            <div>
                                                <span className="text-[10px] font-bold text-zinc-500 block leading-tight">Ratio</span>
                                                <span className="text-white">{aspect === '9:16' ? '9:16 Vertical' : '16:9 Landscape'}</span>
                                            </div>
                                            <svg className="w-4 h-4 text-zinc-600 group-hover:text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                                        </button>
                                        ...
                                        >
                                            <div>
                                                <span className="text-[10px] font-bold text-zinc-500 block leading-tight">Density</span>
                                                <span className="text-white">{visualDensity.name}</span>
                                            </div>
                                            <svg className="w-4 h-4 text-zinc-600 group-hover:text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                                        </button>
                                ...
                                <div>
                                    <h4 className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-3 mt-4 border-b border-white/10 pb-2">Voice Config</h4>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        >
                                            ...
                                            <svg className="w-4 h-4 text-zinc-600 group-hover:text-yellow-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                                        </button>
                                        ...
                                        >
                                            <div className="flex items-center gap-3 w-full min-w-0">
                                                <div className="w-12 h-8 rounded border border-white/10 bg-black shrink-0 overflow-hidden">
                                            ...
                                            <svg className="w-4 h-4 text-zinc-600 group-hover:text-yellow-400 mr-2 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    {configView === 'density' && (
                        <>
                            <div className="flex items-center gap-2 mb-6">
                                ...
                                >
                                    <svg className="w-5 h-5 text-zinc-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
                                </button>
                                <h3 className="font-black text-xl uppercase tracking-tight text-white">Visual Density</h3>
                            </div>
                            ...
                            <div className="space-y-2 overflow-y-auto max-h-[calc(100vh-140px)] pr-2 thin-scrollbar">
                                {VISUAL_DENSITIES.map(d => (
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-3 border rounded-xl transition-all ${visualDensity.id === d.id ? 'bg-yellow-400/10 border-yellow-400' : 'bg-zinc-900 border-white/10 hover:border-white/20'}`}
                                    >
                                        <div className="font-bold flex items-center justify-between text-white">
                                            {d.name}
                                            {visualDensity.id === d.id && <svg className="w-4 h-4 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>}
                                        </div>
                                        <div className="text-xs text-zinc-500 font-medium mt-1">{d.description}</div>
                                    </button>
                                ))}
                            </div>
                        </>
                    ...
                    {configView === 'quality' && (
                        <>
                            <div className="flex items-center gap-2 mb-6">
                                ...
                                <h3 className="font-black text-xl uppercase tracking-tight text-white">Picture Quality</h3>
                            </div>
                            ...
                            <div className="space-y-2 overflow-y-auto max-h-[calc(100vh-140px)] pr-2 thin-scrollbar">
                                {PICTURE_QUALITY_OPTIONS.map(q => (
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-3 border rounded-xl transition-all ${pictureQuality.id === q.id ? 'bg-yellow-400/10 border-yellow-400' : 'bg-zinc-900 border-white/10 hover:border-white/20'}`}
                                    >
                                        <div className="font-bold flex items-center justify-between text-white">
                                            {q.name}
                                            {pictureQuality.id === q.id && <svg className="w-4 h-4 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>}
                                        </div>
                                        <div className="text-xs text-zinc-500 font-medium mt-1">{q.description}</div>
                                    </button>
                                ))}
                            </div>
                        </>
                    ...
                    {configView === 'aspect' && (
                        <>
                            <div className="flex items-center gap-2 mb-6">
                                ...
                                <h3 className="font-black text-xl uppercase tracking-tight text-white">Aspect Ratio</h3>
                            </div>
                            ...
                            <div className="space-y-2">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-3 border rounded-xl transition-all ${aspect === opt.id ? 'bg-yellow-400/10 border-yellow-400' : 'bg-zinc-900 border-white/10 hover:border-white/20'}`}
                                    >
                    ...
                    {configView === 'style' && (
                        <>
                             <div className="flex items-center gap-2 mb-6">
                                ...
                                <h3 className="font-black text-xl uppercase tracking-tight text-white">Image Style</h3>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3 overflow-y-auto max-h-[calc(100vh-140px)] pr-2 thin-scrollbar">
                                {IMAGE_STYLES.map(s => (
                                    <button
                                        ...
                                        className={`relative group flex flex-col gap-2 p-2 border rounded-xl transition-all text-left overflow-hidden ${style === s ? 'border-yellow-400 bg-yellow-400/10' : 'bg-zinc-900 border-white/10 hover:border-white/20'}`}
                                    >
                                        <div className="aspect-square w-full rounded-lg bg-zinc-800 overflow-hidden relative">
                                            ...
                                            {style === s && (
                                                <div className="absolute inset-0 bg-yellow-400/20 flex items-center justify-center">
                                                    <div className="bg-white rounded-full p-1 shadow-sm">
                                                        <svg className="w-4 h-4 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
                                        <span className="font-bold text-xs px-1 text-white">{s}</span>
                                    </button>
                                ))}
                            </div>
                        </>
                            ...
                            <div className="space-y-2 overflow-y-auto max-h-[calc(100vh-140px)] pr-2 thin-scrollbar">
                                {EFFECT_PRESETS.map(e => (
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-3 border rounded-xl transition-all ${effect.id === e.id ? 'bg-yellow-400/10 border-yellow-400' : 'bg-zinc-900 border-white/10 hover:border-white/20'}`}
                                    >
                            ...
                            <div className="space-y-3 overflow-y-auto max-h-[calc(100vh-140px)] pr-2 thin-scrollbar">
                                {SUBTITLE_PRESETS.map(s => (
                                    <button
                                        ...
                                        className={`w-full text-left p-3 border rounded-xl transition-all group ${subtitles.id === s.id ? 'bg-yellow-400/10 border-yellow-400' : 'bg-zinc-900 border-white/10 hover:border-white/20'}`}
                                    >
                                        <div className="aspect-video w-full rounded-lg bg-black mb-3 overflow-hidden border border-white/10 relative">
                                            <SubtitlePreview id={s.id} />
                                            {subtitles.id === s.id && (
                                                <div className="absolute top-2 right-2 bg-yellow-400 rounded-full p-1 shadow-md z-20">
                            ...
                            <div className="space-y-2 overflow-y-auto max-h-[calc(100vh-140px)] pr-2 thin-scrollbar">
                                {VOICES.map(v => (
                                    <button
                                        ...
                                        className={`w-full flex items-center justify-between px-4 py-3 text-sm border rounded-xl transition-all ${voice.id === v.id ? 'bg-yellow-400/10 border-yellow-400' : 'bg-zinc-900 border-white/10 hover:border-white/20'}`}
                                    >
                                        <span className="font-bold text-left text-white">{v.name}</span>
                                        {VOICE_SAMPLES[v.id] && (
                                            <div 
                                                onClick={(e) => toggleVoiceSample(e, v.id)} 
                                                className={`p-1.5 rounded-full shrink-0 ${playingVoiceId === v.id ? 'bg-yellow-400 text-black' : 'bg-zinc-800 text-zinc-400 hover:bg-zinc-700'}`}
                                            >
                            ...
                            <div className="space-y-2 overflow-y-auto max-h-[calc(100vh-140px)] pr-2 thin-scrollbar">
                                {NARRATION_STYLES.map(s => (
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-3 border rounded-xl transition-all ${narrationStyle.id === s.id ? 'bg-yellow-400/10 border-yellow-400' : 'bg-zinc-900 border-white/10 hover:border-white/20'}`}
                                    >
                                        <div className="font-bold flex items-center justify-between text-white">
                                            {s.name}
                                            {narrationStyle.id === s.id && <svg className="w-4 h-4 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>}
                                        </div>
                ...
                {/* Main Content Area */}
                <div className={`flex-1 ${isConfigOpen ? 'md:mr-80' : ''} transition-all duration-300 flex flex-col items-center justify-center p-6 h-full overflow-y-auto no-scrollbar relative bg-black`}>
                     <div className="w-full max-w-3xl flex flex-col gap-6 transition-transform duration-300 -translate-y-[10vh] md:translate-y-0">
                         ...
                         <div className="text-center space-y-2">
                             <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-white">What's your story?</h2>
                         </div>

                         {/* Input Card */}
                         <div className="relative group bg-zinc-900 focus-within:ring-4 focus-within:ring-yellow-400/10 focus-within:border-yellow-400 rounded-[2rem] shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden isolate w-full border-2 border-white/10">
                            {/* Text Area */}
                            <div className="relative z-0">
                                <textarea 
                                    ref={textareaRef}
                                    className="w-full bg-transparent p-8 pb-24 text-lg font-medium outline-none resize-none min-h-[140px] max-h-[50vh] overflow-y-auto placeholder-zinc-600 text-white"
                                ...
                                <div className={`absolute bottom-24 right-8 text-xs font-bold transition-colors ${prompt.length > 6000 ? 'text-red-500' : 'text-zinc-600'}`}>
                                    {prompt.length} / 6000
                                </div>
                            </div>

                            {/* Button Area */}
                            <div className="absolute bottom-0 left-0 right-0 z-10 flex justify-end p-4 bg-gradient-to-t from-zinc-900 via-zinc-900/90 to-transparent h-24 items-end pointer-events-none">
                                <button 
                                    onClick={handleGenerate}
                                    disabled={loading || !prompt.trim() || prompt.length > 6000}
                                    className="px-8 py-3 bg-yellow-400 text-black rounded-full font-black uppercase tracking-wider hover:bg-yellow-300 transition disabled:opacity-50 shadow-lg shadow-yellow-400/20 pointer-events-auto text-sm transform active:scale-95 duration-200"
                                >
